...
class MapboxNavigationView(private val context: ThemedReactContext) :
  ...
  // Following: usuário na área acima do modal (~200dp = trip card + speed + margens)
  private val followingPadding: EdgeInsets by lazy {
    EdgeInsets(60.0 * pixelDensity, 40.0 * pixelDensity, 200.0 * pixelDensity, 40.0 * pixelDensity)
  }
  private val landscapeFollowingPadding: EdgeInsets by lazy {
    EdgeInsets(30.0 * pixelDensity, 380.0 * pixelDensity, 120.0 * pixelDensity, 40.0 * pixelDensity)
  }
  ...
  private fun updateRadarsOnMap() {
    ...
    val radarsToDisplay = if (currentRoute != null) {
      // Durante navegação: pegar primeiros 1000 radares para garantir que reportes apareçam (aumentado de 300)
      radars.take(1000)
    } else {
    ...
    try {
      val features =
              radarsToDisplay.map { radar: RadarPoint ->
                ...
                // O usuário diz que as placas estão certas (com 180) mas radares estão de cabeça para baixo.
                // Então: Placas = 180, Outros = 0.
                val (iconImage, iconSize, iconRotate) = when {
                  ...
                  radarType.contains("fixo") || radarType.contains("placa") -> {
                    ...
                    Triple(icon, 0.15, 180.0) // Placas precisam de 180 para ficarem "up"
                  }
                  ...
                  radarType.contains("reportado") -> Triple("radar", 0.05, 0.0)
                    ...
                    if (closestSpeed > 0) {
                        Triple("placa$closestSpeed", 0.15, 180.0)
                    } else {
