    ...
    try {
      val features =
              radarsToDisplay.map { radar: RadarPoint ->
                ...
                // Determinar ícone e tamanho baseado no tipo
                val (iconImage, iconSize) = when {
                  radarType.contains("semaforo") -> Pair("radar_semaforico", 0.05)
                  radarType.contains("movel") || radarType.contains("mobile") -> Pair("radarMovel", 0.05)
                  radarType.contains("fixo") -> {
                    // Para radares fixos, usar placa com velocidade
                  ...
                  radarType.contains("lombada") -> Pair("radar", 0.06)
                  radarType.contains("policia") -> Pair("radar", 0.09)
                  radarType.contains("reportado") -> Pair("radar", 0.05)
                  else -> {
